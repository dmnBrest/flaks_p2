...
class User(db.Model, UserMixin):
	...
	google_plus			= db.Column(db.String(255))
	linkedin			= db.Column(db.String(255))
	facebook			= db.Column(db.String(255))
	personal_site		= db.Column(db.String(255))
	geo_manual			= db.Column(db.Boolean)
	geo_lat				= db.Column(db.Float(Precision=64))
	geo_lng				= db.Column(db.Float(Precision=64))
	geo_address			= db.Column(db.String(255))
	sfdc_start			= db.Column(db.Integer)
	sfdc_skills			= db.Column(db.Text)
	sfdc_certificates	= db.Column(db.Text)
