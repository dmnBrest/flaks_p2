...
class UserForm(Form):
	...
	sfdc_start			= SelectField('Start working with Salesforce from', choices=[(None, '- select -'), ('2014', '2014'), ('2013', '2013'), ('2012', '2012'), ('2011', '2011'), ('2010', '2010'), ('2009', '2009')], validators=[validators.Optional()])
